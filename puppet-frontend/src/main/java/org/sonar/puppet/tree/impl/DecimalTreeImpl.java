...
import org.sonar.puppet.tree.DecimalTree;
import org.sonar.puppet.tree.SyntaxToken;
import org.sonar.plugins.puppet.api.visitors.DoubleDispatchVisitor;

public class DecimalTreeImpl extends LiteralTreeImpl implements DecimalTree {

  public DecimalTreeImpl(SyntaxToken floatNumber) {
    super(floatNumber);
  }
